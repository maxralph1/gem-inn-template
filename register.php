...
<body class="d-flex flex-column" style="position: relative">
    ...
    <main class="container last-section-margin">
        <div class="py-5">
            <h2 class="fs-3 fw-bold border-bottom">Register</h2>
        </div>
        ...
        <div class="">
            <form class="needs-validation" novalidate>
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="same-address">My address is the same as my shipping address</label>
                </div>
                ...
                <!-- <button class="w-100 btn btn-danger btn-lg" type="submit"><a href="./login.php" class="text-white text-decoration-none">Register</a></button> -->
                <a class="w-100 btn btn-danger btn-lg text-white text-decoration-none" href="./login.php">Register</a>
            </form>
        </div>
